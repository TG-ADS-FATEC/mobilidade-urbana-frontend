...
class TAppBarTheme {
  ...
  static const lightAppBarTheme = AppBarTheme(
    ...
    titleTextStyle: TextStyle(fontSize: TTextSizes.titleMedium, fontWeight: FontWeight.w600, color: TColors.black),
  ...
  static const darkAppBarTheme = AppBarTheme(
    ...
    titleTextStyle: TextStyle(fontSize: TTextSizes.titleMedium, fontWeight: FontWeight.w600, color: TColors.white),
