...
class TSettingsMenuDeletionTile extends StatefulWidget {
  final IconData icon;
  final String title, subtitle;
  final Widget? trailing;
  final void Function() onTap;

  const TSettingsMenuDeletionTile({
    super.key,
    required this.icon,
    required this.title,
  ...
  @override
  State<TSettingsMenuDeletionTile> createState() => _TSettingsMenuTileState();
}

class _TSettingsMenuTileState extends State<TSettingsMenuDeletionTile>
