// lib/utils/debug/onboarding_debug_page.dart
import 'package:flutter/material.dart';
import 'package:mobilidade_urbana_app/features/onboarding/services/onboarding_hive_service.dart';
...
class _OnboardingDebugPageState extends State<OnboardingDebugPage> {
  ...
  Widget build(BuildContext context) {
    final data = OnboardingHiveService.load();
      ...
      body: Padding(
        ...
        child: data == null
          ...
          children: [
            ...
            FilledButton(
              onPressed: () async {
                await OnboardingHiveService.save(
                  OnboardingHiveService.load()!
                    ..isSynced = false,
                );
                setState(() {});
